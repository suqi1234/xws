...
extern "C" IL2CPP_METHOD_ATTR bool MultipleDisplayUtilities_GetRelativeMousePositionForDrag_m4185058580 (RuntimeObject * __this /* static, unused */, PointerEventData_t3807901092 * ___eventData0, Vector2_t2156229523 * ___position1, const RuntimeMethod* method);
...
extern "C" IL2CPP_METHOD_ATTR RaycastResult_t3360306849  PointerEventData_get_pointerPressRaycast_m2795884860 (PointerEventData_t3807901092 * __this, const RuntimeMethod* method);
...
extern "C" IL2CPP_METHOD_ATTR void Slider_UpdateDrag_m1102107039 (Slider_t3903728902 * __this, PointerEventData_t3807901092 * ___eventData0, Camera_t4157153871 * ___cam1, const RuntimeMethod* method)
{
	...
	Slider_t3903728902 * G_B10_0 = NULL;
	Slider_t3903728902 * G_B9_0 = NULL;
	float G_B11_0 = 0.0f;
	Slider_t3903728902 * G_B11_1 = NULL;
	{
...
IL_0014:
	...
	}
	{
		...
		bool L_12 = MultipleDisplayUtilities_GetRelativeMousePositionForDrag_m4185058580(NULL /*static, unused*/, L_11, (&V_3), /*hidden argument*/NULL);
		if (L_12)
		{
			goto IL_0060;
		}
...
IL_0060:
	{
		RectTransform_t3704657025 * L_13 = V_0;
		Vector2_t2156229523  L_14 = V_3;
		Camera_t4157153871 * L_15 = ___cam1;
		IL2CPP_RUNTIME_CLASS_INIT(RectTransformUtility_t1743242446_il2cpp_TypeInfo_var);
		bool L_16 = RectTransformUtility_ScreenPointToLocalPointInRectangle_m2327269187(NULL /*static, unused*/, L_13, L_14, L_15, (&V_4), /*hidden argument*/NULL);
		if (L_16)
		{
			goto IL_0074;
		}
...
IL_0074:
	{
		...
		V_5 = L_19;
		Vector2_t2156229523  L_20 = Rect_get_position_m2115952571((&V_5), /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Vector2_t2156229523_il2cpp_TypeInfo_var);
		Vector2_t2156229523  L_21 = Vector2_op_Subtraction_m73004381(NULL /*static, unused*/, L_17, L_20, /*hidden argument*/NULL);
		V_4 = L_21;
		Vector2_t2156229523  L_22 = V_4;
		Vector2_t2156229523  L_23 = __this->get_m_Offset_29();
		Vector2_t2156229523  L_24 = Vector2_op_Subtraction_m73004381(NULL /*static, unused*/, L_22, L_23, /*hidden argument*/NULL);
		V_7 = L_24;
		int32_t L_25 = Slider_get_axis_m2224049704(__this, /*hidden argument*/NULL);
		float L_26 = Vector2_get_Item_m3559215723((&V_7), L_25, /*hidden argument*/NULL);
		RectTransform_t3704657025 * L_27 = V_0;
		NullCheck(L_27);
		Rect_t2360479859  L_28 = RectTransform_get_rect_m574169965(L_27, /*hidden argument*/NULL);
		V_8 = L_28;
		Vector2_t2156229523  L_29 = Rect_get_size_m477575021((&V_8), /*hidden argument*/NULL);
		V_9 = L_29;
		int32_t L_30 = Slider_get_axis_m2224049704(__this, /*hidden argument*/NULL);
		float L_31 = Vector2_get_Item_m3559215723((&V_9), L_30, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Mathf_t3464937446_il2cpp_TypeInfo_var);
		float L_32 = Mathf_Clamp01_m56433566(NULL /*static, unused*/, ((float)((float)L_26/(float)L_31)), /*hidden argument*/NULL);
		V_6 = L_32;
		bool L_33 = Slider_get_reverseValue_m2613930318(__this, /*hidden argument*/NULL);
		G_B9_0 = __this;
		if (!L_33)
		{
			G_B10_0 = __this;
	...
	{
		float L_34 = V_6;
		G_B11_0 = ((float)il2cpp_codegen_subtract((float)(1.0f), (float)L_34));
		G_B11_1 = G_B9_0;
		goto IL_00e9;
	}
...
IL_00e9:
	{
		NullCheck(G_B11_1);
		Slider_set_normalizedValue_m480470123(G_B11_1, G_B11_0, /*hidden argument*/NULL);
	}
...
IL_0012:
	...
	}
	{
		...
		NullCheck(L_7);
		RaycastResult_t3360306849  L_8 = PointerEventData_get_pointerPressRaycast_m2795884860(L_7, /*hidden argument*/NULL);
		V_0 = L_8;
		Vector2_t2156229523  L_9 = (&V_0)->get_screenPosition_9();
		PointerEventData_t3807901092 * L_10 = ___eventData0;
		NullCheck(L_10);
		Camera_t4157153871 * L_11 = PointerEventData_get_enterEventCamera_m2055275918(L_10, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(RectTransformUtility_t1743242446_il2cpp_TypeInfo_var);
		bool L_12 = RectTransformUtility_RectangleContainsScreenPoint_m4031431712(NULL /*static, unused*/, L_6, L_9, L_11, /*hidden argument*/NULL);
		if (!L_12)
		{
			goto IL_008d;
		}
	...
	{
		RectTransform_t3704657025 * L_13 = __this->get_m_HandleRect_17();
		PointerEventData_t3807901092 * L_14 = ___eventData0;
		NullCheck(L_14);
		RaycastResult_t3360306849  L_15 = PointerEventData_get_pointerPressRaycast_m2795884860(L_14, /*hidden argument*/NULL);
		V_2 = L_15;
		Vector2_t2156229523  L_16 = (&V_2)->get_screenPosition_9();
		...
		IL2CPP_RUNTIME_CLASS_INIT(RectTransformUtility_t1743242446_il2cpp_TypeInfo_var);
		bool L_19 = RectTransformUtility_ScreenPointToLocalPointInRectangle_m2327269187(NULL /*static, unused*/, L_13, L_16, L_18, (&V_1), /*hidden argument*/NULL);
		if (!L_19)
		{
			goto IL_0087;
		}
...
IL_008d:
	{
		...
		PointerEventData_t3807901092 * L_22 = ___eventData0;
		NullCheck(L_22);
		Camera_t4157153871 * L_23 = PointerEventData_get_pressEventCamera_m2613974917(L_22, /*hidden argument*/NULL);
		Slider_UpdateDrag_m1102107039(__this, L_21, L_23, /*hidden argument*/NULL);
	}
