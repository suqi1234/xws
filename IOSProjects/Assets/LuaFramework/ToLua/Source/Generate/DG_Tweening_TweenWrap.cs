...
public class DG_Tweening_TweenWrap
{
	...
	static int Play(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes<DG.Tweening.Tween>(L, 1))
			{
			...
			else if (count == 1 && TypeChecker.CheckTypes<DG.Tweening.Tween>(L, 1))
			{
				DG.Tweening.Tween obj = (DG.Tweening.Tween)ToLua.ToObject(L, 1);
				DG.Tweening.Tween o = obj.Play();
				ToLua.PushObject(L, o);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: DG.Tweening.Tween.Play");
			}
		}
		catch (Exception e)
		{
	...
	static int Pause(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: DG.Tweening.Tween.Pause");
			}
		}
		catch (Exception e)
		{
	...
	static int SetAs(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<DG.Tweening.Tween>(L, 2))
			{
				DG.Tweening.Tween obj = (DG.Tweening.Tween)ToLua.CheckObject<DG.Tweening.Tween>(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes<DG.Tweening.TweenParams>(L, 2))
			{
				DG.Tweening.Tween obj = (DG.Tweening.Tween)ToLua.CheckObject<DG.Tweening.Tween>(L, 1);
