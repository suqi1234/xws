...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		AnimationCurveManagerWrap.Register(L);
		...
		LuaFramework_ScenesManagerWrap.Register(L);
		LuaFramework_MaterialManagerWrap.Register(L);
		L.EndModule();
		L.BeginModule("DwcExtension");
		DwcExtension_EventTriggerListenerWrap.Register(L);
		L.EndModule();
		L.BeginModule("Language");
		Language_LanguageServiceWrap.Register(L);
		Language_LanguageTextWrap.Register(L);
		Language_LanguageInfoWrap.Register(L);
		L.EndModule();
