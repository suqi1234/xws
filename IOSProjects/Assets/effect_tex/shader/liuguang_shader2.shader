    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                float2 node_7209 = (i.uv0+i.vertexColor.a*float2(5,0));
